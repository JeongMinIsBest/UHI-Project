...
전주시를 대상으로 도시 열섬 현상을 분석하고, 녹지 공간 추천, 열섬 지도 시각화,  
열섬 지식 퀴즈 기능을 제공하는 전주시 열섬 지도 · 녹지 추천 · 퀴즈 애플리케이션입니다. 
...
### 1. 메인 화면
- 현재 위치 권한 요청 → 기상청 API로 온도 및 열섬 지수 안내
- 녹지 추천 / 퀴즈 기능 실행 버튼
...
## 👥 팀원 역할
- **강지현** : 열섬 지식 퀴즈 구현
- **김세현** : 열섬 지도 구현, DB 및 GitHub 관리, 현재 기온 안내
